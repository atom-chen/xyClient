...
local controler_guild_gongxian_node = class("controler_guild_gongxian_node")
...
function controler_guild_gongxian_node:ctor( guild_gongxian_node )
	self:_initModels()

	self._guild_gongxian_node = guild_gongxian_node

	self._panle = self._guild_gongxian_node:getChildByName("Panel")
...
function controler_guild_gongxian_node:getView()
	return self._guild_gongxian_node
end

function controler_guild_gongxian_node:addEventListener( callBack )
	self._controlerEventCallBack = callBack
end


function controler_guild_gongxian_node:_initModels()
	self._controlerEventCallBack = nil
end

function controler_guild_gongxian_node:_registGlobalEventListeners()
    self._globalEventListeners = {}
end

--注册节点事件
function controler_guild_gongxian_node:_registNodeEvent()
    local function onNodeEvent(event)
        if "exit" == event then
            self:_removeAllGlobalEventListeners()
        end
    end
    self._guild_gongxian_node:registerScriptHandler(onNodeEvent)
end


function controler_guild_gongxian_node:_removeAllGlobalEventListeners()
    for k,v in pairs(self._globalEventListeners) do
        GLOBAL_EVENT_DISPTACHER:removeEventListener(v)
    end
end

function controler_guild_gongxian_node:_registUIEvent()
...
function controler_guild_gongxian_node:_initListView()
	self._listView = self._panle:getChildByName("ListView")

	local listItemTempleate = self._guild_gongxian_node:getChildByName("ListView_itemTempleate")
...
function controler_guild_gongxian_node:_pushItems()
...
function controler_guild_gongxian_node:_doEventCallBack( sender, eventName, data )
...
return controler_guild_gongxian_node
