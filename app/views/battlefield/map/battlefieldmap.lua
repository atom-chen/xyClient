...
local battlefieldmap = class("battlefieldmap", cc.load("mvc").ViewBase)

function battlefieldmap:ctor(  )
	self.rootnode = cc.CSLoader:createNode("ui_instance/battlefield/battle_map.csb") --testlayer
    ...
    print("battlefieldmap ===========>",self.width,self.height)
...
--设置开场动画
function battlefieldmap:openAnimationEffect()
...
function battlefieldmap:updateMapShow( mapId )
...
--注册事件
function battlefieldmap:registerEvent()
    -- body
end
