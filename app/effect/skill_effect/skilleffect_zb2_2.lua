...
local skilleffect_zb2_2 = class("skilleffect_zb2_2")

function skilleffect_zb2_2:ctor()
	-- body
end
...
function skilleffect_zb2_2:setData( parame )
...
--施法聚焦
function skilleffect_zb2_2:CastFocus(  )
	--目标进入攻击层
...
--创建攻击动作
function skilleffect_zb2_2:CreateAttackEffect(  )
...
--创建打击效果
function skilleffect_zb2_2:CreateAttackBlowEffect(  )
...
--创建伤害效果
function skilleffect_zb2_2:CreateHurtEffect(  )
...
--设置完成回调函数
function skilleffect_zb2_2:setFinishCallback( callfun )
	self.FinishCallback = callfun;
end

---------------------------------------------------
--攻击效果回调监听
function skilleffect_zb2_2:setAttackEffectListen( listenerType,armatureName,movementType ,object )
...
function skilleffect_zb2_2:setHurtCreateListen( listenerType,armatureName,movementType ,object  )
	if listenerType == "AnimationEvent" then
		if movementType == ccs.MovementEventType.complete then
